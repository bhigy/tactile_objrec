...
const std::string fingerName[] = {"thumb", "index", "middle", "ring", "little"};
...
private:
    ...
    Vector                              playPianoStartPos[2];
    Vector                              playPianoStartOrient[2];
    Vector                              playPianoEndPos[2];
    Vector                              playPianoEndOrient[2];


    Bottle                              bGraspModel[2];
...
public:
    ...
    // output the grasp models
    void extractGraspModel();
    void sendGraspModel();
